...
export class StateRaces extends Component {
    ...
    componentDidUpdate(prevProps, prevState, prev) {
        if(prevProps.match.params.year !== this.getYear()) {
            this.doRaces();
        }
    }
    ...
    getYear() {
        return this.props.match.params.year ? this.props.match.params.year : 2018
    }
                   ...
                   : <span>{`${race.name}`}</span>
                    ...
                    <Navbar.Collapse>
                        ...
                        <Nav pullRight>
                            ...
                            {!race.complete && <NavItem target="_blank"
                                                        href={`https://www.usacycling.org/register/${race.year}-${race.id}`}>Register</NavItem>}
                        </Nav>
                        }
                        {!race.id &&
                        <Nav pullRight>
